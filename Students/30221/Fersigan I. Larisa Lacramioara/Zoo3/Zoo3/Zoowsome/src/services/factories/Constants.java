...
public final class Constants {
	...
	public static final class Employee{
		...
		public static final String Ionut= "Ionut";
		public static final String Larisa= "Larisa";
		public static final String Luca= "Luca";
...
public static final class Bird {
	public static final String Parrots = "PARROTS";
	public static final String Stork = "STORK";
	public static final String Pinguin = "PINGUIN";
}
