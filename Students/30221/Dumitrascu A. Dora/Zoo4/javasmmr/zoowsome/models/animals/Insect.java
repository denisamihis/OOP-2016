...
abstract class Insect extends Animal{
	...
	public void decodeFromXml(Element element) {
		setCare(Boolean.valueOf(element.getElementsByTagName("canFly").item(0).getTextContent()));
		setCare(Boolean.valueOf(element.getElementsByTagName("isDangerous").item(0).getTextContent()));
		}
