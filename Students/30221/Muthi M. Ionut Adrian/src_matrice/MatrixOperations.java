...
public class MatrixOperations {
	...
	public static void isZeroMatrix(BigDecimal[][] a){
		...
		if (el==zero)
			System.out.println("Matricea este plina cu 0 ");
		else 
			System.out.println("Matricea nu este plina cu 0");
		
	}
	
	
	public static void identityMatrix(BigDecimal[][] a){
		int row,col;
		...
		for( row=0;row<a.length;row++){
		 ...
		 if(da==0)
			 System.out.println("Matricea este egala cu matricea identitate ");
		 else
			 System.out.println("Matricea nu este egala cu matrica identitate ");
		
	}
	
	 public static void fillDegree(BigDecimal[][] a){
		 int row,col,sum=0,n;
		 float procent;
		 int zero1=0;
		 BigDecimal zero=BigDecimal.valueOf(zero1);
		 ...
		 System.out.println(procent*100 + " % of the matrix is filled");
	 }
